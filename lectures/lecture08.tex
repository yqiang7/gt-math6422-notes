...
\begin{proof}
  ...
  Thus $\varphi^* \widetilde{M} = \coker(\widetilde{B^{\oplus J}} \to \widetilde{B^{\oplus I}}) = (\coker(B^{\oplus J} \to B^{\oplus I}))\widetilde{\ } = \widetilde{M \otimes_A B}$.
\end{proof}
