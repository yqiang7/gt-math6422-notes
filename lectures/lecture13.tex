...
\begin{proof}
  ...
  \[
    \begin{tikzcd}
      B \ar[d] \ar[r, "d"] & \Omega_{B / A} \ar[d, "D", dashed] \ar[dr] \\
      S^{-1} B \ar[r] \ar[rr, bend right, "d'", swap] & M & S^{-1} \Omega_{B / A} \ar[l, dashed, "S^{-1} D"]
    \end{tikzcd}
  \]
  Note that by the universal property of
  localization,
  we get a unique map $S^{-1} D$ that
  fits into the above diagram. Then
  one can check that the map
  \begin{align*}
    d' : S^{-1} B &\longrightarrow S^{-1} \Omega_{B / A} \\
...
\begin{prop}\label{prop:properties-differentials}
  ...
  \begin{enumerate}
    \item For $A$-algebras $B_1$ and
      $B_2$, we have
      $\Omega_{(B_1 \otimes_A B_2) / A} \cong (\Omega_{B_1 / A} \otimes_A B_2) \oplus (B_1 \otimes_A \Omega_{B_2 / A})$.
    ...
    \item To compute $\Omega_{\PP^n}$, note
      ...
      \[
        \begin{tikzcd}[row sep=tiny]
          \Omega_{\PP^n}(U_i)
          \ar[r] & \bigoplus_{j = 1}^{n + 1} \OO_{\PP^n}(-1)(U_i)
